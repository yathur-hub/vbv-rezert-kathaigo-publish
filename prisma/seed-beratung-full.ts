...
import { beratungContent } from '../src/data/beratung-content';

async function main() {
  console.log('Seeding FULL content for Beratung & Compliance Track (7 Modules, 70 Questions)...');
  ...
  for (const moduleData of beratungContent) {
    console.log(`Processing Module: ${moduleData.moduleTitle}...`);
